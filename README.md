...
The program **"run_analysis.R"** was created to clean the raw data (“Human Activity Recognition Using Smartphones” data set) for further data analysis.  The compressed raw data was downloaded at
